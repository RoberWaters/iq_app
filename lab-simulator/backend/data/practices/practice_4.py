PRACTICE_4 = {
    ...
    "assemblySteps": [
        ...
        },
        {
            ...
            "id": "agregar_hno3",
            "action": "measure_with_bottle",
            "description": "Medir 1 mL de HNO₃ 1:1 con la probeta y agregar al matraz",
            "reagent": "HNO3-1A1",
            "volume": 1,
            "unit": "mL",
            "bottleLabel": "HNO₃\n1:1",
        ...
        },
        {
            ...
            "id": "agregar_agno3",
            "action": "measure_with_bottle",
            "description": "Medir 50 mL de AgNO₃ 0.10 M con la probeta y agregar al matraz",
            "reagent": "AGNO3-010M",
            "volume": 50,
            "unit": "mL",
            "bottleLabel": "AgNO₃\n0.10 M",
        ...
        },
        {
            ...
            "action": "measure_with_bottle",
            "description": "Medir 1 mL de nitrobenceno con la probeta y agregar al matraz",
            "reagent": "NITROBENZ",
            "volume": 1,
            "unit": "mL",
            "bottleLabel": "Nitro-\nbenceno",
            ...
            "visualAfter": {
                ...
                "precipitate": {"type": "compact", "color": "#F5F5E8", "opacity": 0.8},
                "foilCovered": True,
            },
        },
        {
    ...
    "titration": {
        ...
        "precipitate": {
            "layers": [
                {"type": "compact", "color": "#F5F5E8", "opacity": 0.8, "density": 0.6},
                {"type": "granular", "color": "#FFFFFF", "opacity": 0.9, "density": 0.5, "dynamic": True},
            ],
        },
